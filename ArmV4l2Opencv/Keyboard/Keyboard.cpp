...
const QString BACKSPACE_ICON = ":/resource/images/KeyboardImage/backspace.png";
const QString ENTER_ICON     = ":/resource/images/KeyboardImage/enter.png";
const QString SPACE_ICON     = ":/resource/images/KeyboardImage/space.png";
const QString CAPLOCK_ICON   = ":/resource/images/KeyboardImage/caplock.png";
...
{
    QFile pinyin(":/resource/ChineseLib/pinyin.txt");
...
{
    /* 加载词组字库内容 */
    QFile pinyin(":/resource/ChineseLib/pinyin_phrase.txt");
    if (! pinyin.open(QIODevice::ReadOnly)) {
        qDebug() << "Open pinyin file failed!";
        return;
    }
